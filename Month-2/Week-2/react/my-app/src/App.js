...
import Toggleh1 from './components/Toggleh1';
  ...
  return (
    <div className='App'>
      ...
      <div className='state br'>
        ...
        <Button className='hrjbtn' onClick={S_counters}>Increment</Button>
        <h1>count : {scount}</h1>
      </div>

      <div className='props br'>
        <h1>Counter using Props</h1>
        <Button className='hrjbtn' onClick={P_counters}>Increment</Button>
